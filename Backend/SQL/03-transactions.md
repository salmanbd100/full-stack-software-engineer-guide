...
- [Chapter ?? — Indexes, Query Plans, ORMs and Migrations](#ch-indexes) — why a lock is held longer than you expected, and how an ORM wraps a transaction
- [Chapter ?? — REST Best Practices and Versioning](#ch-rest-best-practices) — idempotency keys, the HTTP-level version of this problem
