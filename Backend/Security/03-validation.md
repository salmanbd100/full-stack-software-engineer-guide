...
- [Chapter ?? — OAuth, OIDC and Authorisation](#ch-oauth) — validating who may act, once you trust the shape
- [Chapter ?? — SQL Fundamentals and Schema Design](#ch-sql-fundamentals) — the statements being parameterised
- [Chapter ?? — REST Best Practices and Versioning](#ch-rest-best-practices) — the same schema, reused as the published contract
