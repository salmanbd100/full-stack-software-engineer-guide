...
- [Chapter ?? — Reliability, Consistency and CAP](#ch-consistency-and-cap) — the cascade these patterns exist to break
- [Chapter ?? — Service Boundaries and the API Gateway](#ch-service-boundaries) — the calls that need this protection, and where breakers belong at the edge
