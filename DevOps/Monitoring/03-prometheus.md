...
> For Prometheus specifically on EKS — the Operator, ServiceMonitors, scraping pods — see [Kubernetes Monitoring](../Kubernetes/09-monitoring.md). This file covers Prometheus itself.
...
---
[Monitoring Index](./README.md) | [← CloudWatch](./02-cloudwatch.md) | [Grafana →](./04-grafana.md)
