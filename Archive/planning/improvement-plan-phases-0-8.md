> **Archived 2026-09-23.** This is the original 104-item improvement plan, kept whole for the record —
> every item, every **Delivered** block, every correction made along the way. Phases 0–8 are finished;
> item #92 was replaced by the plain-English pass in Phase 9.
>
> **The live plan is [`IMPROVEMENT-PLAN.md`](../../IMPROVEMENT-PLAN.md) at the repo root.** Read that one.
> Nothing here is maintained any more, and its counters are frozen at 103 / 104.
